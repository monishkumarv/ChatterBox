...
import com.example.chatterbox.adapters.RecyclerViewAdapter_Friends;
...
public class HomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabaseReference = mfirebaseDatabase.getReference().child("ChatterBox");
    ...
    public void callRecyclerView(){
        ...
        Log.d(TAG,"Calling RecyclerView");
        ...
        newReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot frienditem: dataSnapshot.getChildren()){
                    Log.d(TAG,"Retrieval in process");
                    ...
                    Log.d(TAG,"Retrieval Successful");
