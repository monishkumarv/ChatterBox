...
import com.example.chatterbox.Messages;
import com.example.chatterbox.R;
import com.example.chatterbox.adapters.RecyclerViewAdapter_Chat;
...
public class ChatWindow extends AppCompatActivity {
    ...
    private void callRecyclerView(ArrayList<Messages> allMessages, Boolean isTyping){
        ...
        RecyclerViewAdapter_Chat adapter = new RecyclerViewAdapter_Chat(getApplicationContext(), allMessages,myPhoneNo,friendPhoneNo,isTyping);
