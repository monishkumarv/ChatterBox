...
import com.example.chatterbox.activities.ChatWindow;
...
public class RecyclerViewAdapter_Friends extends RecyclerView.Adapter<RecyclerViewAdapter_Friends.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        RelativeLayout parentLayout;   // layout of each individual units of the list
    ...
    public void setDateTime(String phoneNo,ViewHolder holder){
        ...
        mReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (todaysdate.equals(String.valueOf(dataSnapshot.child("date").getValue()))){
                    holder.date.setText(String.valueOf(dataSnapshot.child("time").getValue()));
                }else {
                    holder.date.setText(String.valueOf(dataSnapshot.child("date").getValue()));
                }
